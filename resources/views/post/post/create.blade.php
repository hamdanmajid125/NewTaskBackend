    ...
    <div class="container-full">
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="page-title">{{ $data == null ? 'Add' : 'Update ' }} Post
                        {{ $data == null ? '' : '#' . $data->id }}</h3>
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <a href="#"><i class="mdi mdi-home-outline">Post Management</i></a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ $data == null ? 'Add' : 'Update ' }} Post</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-12">
                    <div class="box">
                        ...
                        <div class="box-header with-border">
                            <h4 class="box-title">{{ $data == null ? 'Upload' : 'Update ' }} Post Details</h4>
                        </div>
                        <!-- /.box-header -->
                        <form class="form" method="post"
                            action="{{ $data == null ? route('post.store') : route('post.update', $data->id) }}"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group{{ $errors->has('user_id') ? 'has-error' : '' }}">
                                            ...
                                            <input class="form-control" name="user_id" type="number" id="user_id"
                                                value="{{ $data == null ? old('user_id') : $data->user_id }}">
