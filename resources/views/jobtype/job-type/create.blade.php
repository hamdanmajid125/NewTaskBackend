...
@section('title', 'Add JobType ')
@section('content')
    <div class="container-full">
        <div class="content-header">
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    <h3 class="page-title">{{ $data == null ? 'Add' : 'Update ' }} JobType
                        ...
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">
                                    {{ $data == null ? 'Add' : 'Update ' }} JobType</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-12">
                    <div class="box">
                        ...
                        <div class="box-header with-border">
                            <h4 class="box-title">{{ $data == null ? 'Upload' : 'Update ' }} JobType Details</h4>
                        </div>
                        <!-- /.box-header -->
                        <form class="form" method="post"
                            action="{{ $data == null ? route('job-type.store') : route('job-type.update', $data->id) }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group{{ $errors->has('job') ? 'has-error' : '' }}">
                                            ...
                                            <input class="form-control" name="job" type="text" id="job"
                                                value="{{ $data == null ? old('job') : $data->job }}">
