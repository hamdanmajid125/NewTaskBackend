...
@section('title', 'JobType List')
@section('content')
<div class="container-full">
	<div class="content-header">
	    <div class="d-flex align-items-center">
	        <div class="mr-auto">
	            <h3 class="page-title">JobType List</h3>
	            <div class="d-inline-block align-items-center">
	                <nav>
	                    <ol class="breadcrumb">
	                        <li class="breadcrumb-item">
	                        	<a href="#"><i class="mdi mdi-home-outline">JobType Management</i></a>
	                        </li>
	                        <li class="breadcrumb-item active" aria-current="page">JobType List</li>
	                    </ol>
	                </nav>
	            </div>
	        </div>
		...
		<div class="card">
		    <div class="card-header">
	    		<div class="col-md-6 pl-0">
	    			<h4 class="card-title">JobType Lists</h4>
	    		</div>
	    		<div class="col-md-6">
	    			<form method="get" action="{{ route('job-type.index') }}">
		...
		<div class="row" id="section-content">
			...
			<div class="col-md-12 col-lg-4">
			    <div class="card">
			        ...
			        <div class="card-body">
			            <h4 class="card-title">{{ $value->job }}</h4>
			        </div>
			        <div class="card-footer justify-content-between d-flex">
			            ...
			            <ul class="list-inline mb-0">
			                <li><a href="{{ route('job-type.edit', $value->id) }}">Edit</a></li>
			                <li>
			                	<form action="{{ route('job-type.destroy', $value->id) }}" method="POST">
			                		@csrf
			                		@method('DELETE')
