            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-horizontal" method="post" action="{{ route('postGenerator') }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="relationships" class="form-control" id="relationships"
                                        placeholder="comments#hasMany#App\Comment">
                            ...
                            <div class="form-group row">
                                <label for="soft_deletes" class="col-md-4 col-form-label text-right">Want to use soft
                                    deletes?</label>
                                <div class="col-md-6">
